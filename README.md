...
## Environments
- Preview: https://main--cbalanescu-richemont--aemdemos.aem.page/
- Live: https://main--cbalanescu-richemont--aemdemos.aem.live/
- Block Library: https://main--cbalanescu-richemont--aemdemos.aem.page/tools/sidekick/library.html?plugin=blocks
...
1. Open the `cbalanescu-richemont` directory in your favorite IDE and start coding :)
